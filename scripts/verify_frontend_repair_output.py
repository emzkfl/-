...
REQUIRED_RENDER_MARKERS = {
    ...
    "plan.repairDecisionMatrix": "repair decision matrix",
    ...
    "roadmapSummary.bossImpact": "roadmap boss impact summary",
    "roadmapBossImpact": "roadmap boss impact variable",
    "decisionMatrix": "decision matrix variable",
